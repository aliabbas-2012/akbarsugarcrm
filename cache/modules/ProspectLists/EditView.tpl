...
<script type="text/javascript">
addForm('EditView');addToValidate('EditView', 'assigned_user_id', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_ID' module='ProspectLists' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='ProspectLists' for_js=true}{literal}' );
addToValidate('EditView', 'name', 'varchar', true,'{/literal}{sugar_translate label='LBL_NAME' module='ProspectLists' for_js=true}{literal}' );
addToValidate('EditView', 'list_type', 'enum', true,'{/literal}{sugar_translate label='LBL_TYPE' module='ProspectLists' for_js=true}{literal}' );
addToValidate('EditView', 'date_entered_date', 'date', false,'Date Created' );
addToValidate('EditView', 'date_modified_date', 'date', false,'Date Modified' );
addToValidate('EditView', 'modified_user_id', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_MODIFIED' module='ProspectLists' for_js=true}{literal}' );
addToValidate('EditView', 'modified_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MODIFIED' module='ProspectLists' for_js=true}{literal}' );
addToValidate('EditView', 'created_by', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_CREATED' module='ProspectLists' for_js=true}{literal}' );
addToValidate('EditView', 'created_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CREATED' module='ProspectLists' for_js=true}{literal}' );
addToValidate('EditView', 'deleted', 'bool', false,'{/literal}{sugar_translate label='LBL_CREATED_BY' module='ProspectLists' for_js=true}{literal}' );
addToValidate('EditView', 'description', 'text', false,'{/literal}{sugar_translate label='LBL_DESCRIPTION' module='ProspectLists' for_js=true}{literal}' );
addToValidate('EditView', 'domain_name', 'varchar', false,'{/literal}{sugar_translate label='LBL_DOMAIN_NAME' module='ProspectLists' for_js=true}{literal}' );
addToValidate('EditView', 'entry_count', 'int', false,'{/literal}{sugar_translate label='LBL_LIST_ENTRIES' module='ProspectLists' for_js=true}{literal}' );
addToValidate('EditView', 'marketing_id', 'varchar', false,'{/literal}{sugar_translate label='LBL_MARKETING_ID' module='ProspectLists' for_js=true}{literal}' );
addToValidate('EditView', 'marketing_name', 'varchar', false,'{/literal}{sugar_translate label='LBL_MARKETING_NAME' module='ProspectLists' for_js=true}{literal}' );
addToValidateBinaryDependency('EditView', 'assigned_user_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='ProspectLists' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_ASSIGNED_TO' module='ProspectLists' for_js=true}{literal}', 'assigned_user_id' );
